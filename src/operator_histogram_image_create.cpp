...
void Operator_histogram_image_create::run(std::list<Data_source_descriptor *> &input_data_sources,
  ...
  double lower_value;
  bool saw_lower_value = Operator_utils::get_real_parameter("Operator_histogram_image_create::run",
                                                            operator_parameters,
                                                            "lower_value",
                                                            lower_value,
                                                            errors);
  double upper_value;
  bool saw_upper_value = Operator_utils::get_real_parameter("Operator_histogram_image_create::run",
