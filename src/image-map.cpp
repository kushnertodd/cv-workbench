...
int main(int argc, char **argv) {
  ...
  double lower_out;
  double upper_out;
  if (!wb_utils::string_to_double(lower_in_str, lower_in)) errors.add("", "", "invalid lower_in: " + lower_in_str);
  if (!wb_utils::string_to_double(upper_in_str, upper_in)) errors.add("", "", "invalid lower_in: " + upper_in_str);
