...
int main(int argc, char **argv) {
    ...
    Image *input_image = Image::read_jpeg(wb_in_filename->to_jpeg(), errors);
    errors.check_exit("cannot read in-filename");
    input_image->write_text(wb_in_filename->to_text(), "\t", errors);
    ...
    std::unique_ptr<Image> dilate_image(Morphology::dilate(
            input_image, WB_morphology_types::Structuring_element_type::CROSS, nrows, ncols, thickness, errors));
    ...
    std::unique_ptr<Image> erode_image(Morphology::erode(
            input_image, WB_morphology_types::Structuring_element_type::CROSS, nrows, ncols, thickness, errors));
    ...
    std::unique_ptr<Image> close_image(Morphology::close(
            input_image, WB_morphology_types::Structuring_element_type::CROSS, nrows, ncols, thickness, errors));
    ...
    std::unique_ptr<Image> open_image(Morphology::open(
            input_image, WB_morphology_types::Structuring_element_type::CROSS, nrows, ncols, thickness, errors));
