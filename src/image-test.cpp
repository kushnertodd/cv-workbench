...
int main(int argc, char **argv) {
  ...
  Image *image_8U = new Image(3, 2, 1, CV_image_depth::depth::CV_8U);
  pixel_8U buf_8U[20];
  memcpy(buf_8U, "test..", 6);
  image_8U->add_8U(buf_8U, 6, errors);
  image_8U->write("image-test-8U.bin", errors);

  Image *image_32S = new Image(3, 2, 1, CV_image_depth::depth::CV_32S);
  ...
  Image *image_32F = new Image(3, 2, 1, CV_image_depth::depth::CV_32F);
