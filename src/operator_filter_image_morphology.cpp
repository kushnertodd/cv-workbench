    ...
    if (!errors.has_error()) {
      ...
      if (!errors.has_error() && input != nullptr) {
        if (operator_str == "erode") {
          ...
          if (!errors.has_error())
            Operator_utils::write_operator_image(output_data_stores.front(), erode_image.get(), "Operator_filter_image_morphology::run", errors);
          ...
          if (!errors.has_error())
            Operator_utils::write_operator_image(output_data_stores.front(), dilate_image.get(), "Operator_filter_image_morphology::run", errors);
          ...
          if (!errors.has_error())
            Operator_utils::write_operator_image(output_data_stores.front(), open_image.get(), "Operator_filter_image_morphology::run", errors);
          ...
          if (!errors.has_error())
            Operator_utils::write_operator_image(output_data_stores.front(), close_image.get(), "Operator_filter_image_morphology::run", errors);
          ...
          if (!errors.has_error())
            Operator_utils::write_operator_image(output_data_stores.front(), gradient_image.get(), "Operator_filter_image_morphology::run", errors);
          ...
          if (!errors.has_error())
            Operator_utils::write_operator_image(output_data_stores.front(), top_hat_image.get(), "Operator_filter_image_morphology::run", errors);
          ...
          if (!errors.has_error())
            Operator_utils::write_operator_image(output_data_stores.front(), black_hat_image.get(), "Operator_filter_image_morphology::run", errors);
