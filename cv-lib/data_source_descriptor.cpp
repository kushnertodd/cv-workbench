...
Data_source_descriptor *Data_source_descriptor::from_json(json_object *json_data_source_descriptor, Errors &errors) {
    ...
    // parse: ' { "id": ... `
    int id;
    json_object *json_id = get_json_object("from_json", json_data_source_descriptor, "id", json_type_int, errors);
    if (json_id != nullptr) {
    ...
    json_object *json_data_type =
            get_json_object("from_json", json_data_source_descriptor, "type", json_type_string, errors);
    ...
    json_object *json_data_format =
            get_json_object("from_json", json_data_source_descriptor, "format", json_type_string, errors);
    if (json_data_format != nullptr) {
        std::string data_format_str = json_object_get_string(json_data_format);
        data_format = WB_data_format::from_string(data_format_str);
    ...
    json_object *json_repository =
            get_json_object("from_json", json_data_source_descriptor, "repository", json_type_string, errors);
    if (json_repository != nullptr) {
        std::string repository_str = json_object_get_string(json_repository);
        if (repository_str == "berkeley_db") {
            data_source_descriptor = Berkeley_db_data_source_descriptor::from_json(json_data_source_descriptor, id,
                                                                                   data_type, data_format, errors);
        } else if (repository_str == "filesystem") {
            data_source_descriptor = Filesystem_data_source_descriptor::from_json(json_data_source_descriptor, id,
                                                                                  data_type, data_format, errors);
        } else if (repository_str == "internet") {
            data_source_descriptor = Internet_data_source_descriptor::from_json(json_data_source_descriptor, id,
                                                                                data_type, data_format, errors);
        } else {
