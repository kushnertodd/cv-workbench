...
public:
    ...
    bool is_valid_min_nax_theta(int theta);
    bool is_valid_theta_2pi(int theta);
    int min_max_theta_to_theta_2pi(int min_max_theta);
    ...
    int theta_2pi_to_theta(int theta_2pi);
};
