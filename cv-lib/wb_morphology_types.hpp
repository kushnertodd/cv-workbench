...
public:
    ...
    static const std::map<WB_morphology_types::Structuring_element_type, std::string>
            to_structuring_element_type_strings;
    ...
    static std::string
    to_structuring_element_type_string(WB_morphology_types::Structuring_element_type structuring_element_type);
