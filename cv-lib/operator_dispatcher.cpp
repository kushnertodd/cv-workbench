...
Operator *Operator_dispatcher::create_operator(const std::string &operator_name) {
    ...
    if (operator_name == "filter-edge-color")
        pOperator = new Operator_filter_edge_color();
    else if (operator_name == "filter-edge-kirsch")
        pOperator = new Operator_filter_edge_kirsch();
    else if (operator_name == "filter-edge-laplacian")
        pOperator = new Operator_filter_edge_laplacian();
        ...
        pOperator = new Operator_filter_smooth_average();
    else if (operator_name == "filter-smooth-gaussian")
        pOperator = new Operator_filter_smooth_gaussian();
    else if (operator_name == "filter-smooth-median")
        pOperator = new Operator_filter_smooth_median();
    else if (operator_name == "histogram-hough-create")
        pOperator = new Operator_histogram_hough_create();
    else if (operator_name == "histogram-image-create")
        pOperator = new Operator_histogram_image_create();
    else if (operator_name == "histogram-peak-detect")
        pOperator = new Operator_histogram_peak_detect();
    else if (operator_name == "hough-draw-line")
        pOperator = new Operator_hough_draw_line();
    else if (operator_name == "hough-image-create")
        pOperator = new Operator_hough_image_create();
    else if (operator_name == "hough-peak-detect")
        pOperator = new Operator_hough_peak_detect();
    else if (operator_name == "transform-image-combine")
        pOperator = new Operator_transform_image_combine();
    else if (operator_name == "transform-image-copy")
