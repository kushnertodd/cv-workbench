...
{
    {Image_depth::CV_8U, "CV_8U"},
    {Image_depth::CV_32S, "CV_32S"},
    {Image_depth::CV_32F, "CV_32F"}
};
const std::map<std::string, Image_depth> WB_image_depth::from_strings =
{
    {"CV_8U", Image_depth::CV_8U},
    {"CV_32S", Image_depth::CV_32S},
    {"CV_32F", Image_depth::CV_32F}
};

std::string WB_image_depth::to_string(Image_depth depth) {
