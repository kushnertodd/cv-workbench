...
void Operator_filter_edge_kirsch::run(std::list<Data_source_descriptor *> &input_data_sources,
    ...
    if (!orientation_missing && orientation_str != "N" && orientation_str != "NW" && orientation_str != "W" &&
        orientation_str != "SW" && orientation_str != "S" && orientation_str != "SE" && orientation_str != "E" &&
        orientation_str != "NE")
