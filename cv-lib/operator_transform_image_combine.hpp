#ifndef CV_WORKBENCH_SRC_OPERATOR_TRANSFORM_IMAGE_COMBINE_HPP_
#define CV_WORKBENCH_SRC_OPERATOR_TRANSFORM_IMAGE_COMBINE_HPP_

#include "operator.hpp"

class Operator_transform_image_combine : public Operator {
public:
    ~Operator_transform_image_combine() override;
...
#endif // CV_WORKBENCH_SRC_OPERATOR_TRANSFORM_IMAGE_COMBINE_HPP_
