...
namespace wb_utils {
    ...
    void read_double(FILE *fp, double &var, const std::string &module, const std::string &id, const std::string &error,
                     Errors &errors);
    void read_double_buffer(FILE *fp, double *buf, int count, const std::string &module, const std::string &id,
                            const std::string &error, Errors &errors);
    void read_float(FILE *fp, float &var, const std::string &module, const std::string &id, const std::string &error,
                    Errors &errors);
    void read_float_buffer(FILE *fp, float *buf, int count, const std::string &module, const std::string &id,
                           const std::string &error, Errors &errors);
    void read_int(FILE *fp, int &var, const std::string &module, const std::string &id, const std::string &error,
                  Errors &errors);
    void read_int_buffer(FILE *fp, int *buf, int count, const std::string &module, const std::string &id,
                         const std::string &error, Errors &errors);
    ...
    bool string_in_list(const std::string string, const std::vector<std::string> string_list);
    ...
    void write_double_buffer(FILE *fp, double *buf, int count, const std::string &module, const std::string &id,
                             const std::string &error, Errors &errors);
    void write_float(FILE *fp, float value, const std::string &module, const std::string &id, const std::string &error,
                     Errors &errors);
    void write_float_buffer(FILE *fp, float *buf, int count, const std::string &module, const std::string &id,
                            const std::string &error, Errors &errors);
    void write_int(FILE *fp, int value, const std::string &module, const std::string &id, const std::string &error,
                   Errors &errors);
    void write_int_buffer(FILE *fp, int *buf, int count, const std::string &module, const std::string &id,
                          const std::string &error, Errors &errors);
} // namespace wb_utils
